    ...
    const handleAddUser = async (userData: any) => {
        ...
        try {
            ...
            showAlert({
                type: "success",
                title: `Fleet Added!`,
                message: `Fleet Added Successfully to the SA-Enterprize System`,
        ...
        <Card bordered={false} className="w-full max-w-4xl mx-auto shadow-lg p-6 rounded-lg">
            ...
            <div>
                <div className="mb-6">
                    ...
                    <Paragraph type="secondary">Fill in the details to add a new fleet to the system</Paragraph>
                </div>

                <Form form={form} layout="vertical" onFinish={handleSubmit} requiredMark="optional" className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <Form.Item name="fleet_number" label="Fleet Number" rules={[{ required: true, message: "Fleet number is required" }]}>
                            <Input size="large" />
                        </Form.Item>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <Form.Item name="fleet_type" label="Fleet Type" rules={[{ required: true, message: "Fleet type is required" }]}>
