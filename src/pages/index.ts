...
const SELECT_PROJECT = React.lazy(() => import("./SelectProject"));
...
const MANAGE_OPRATION_CREATE = React.lazy(
  () => import("./ManageOprations/Create")
);
const MANAGE_OPRATION_VIEW = React.lazy(() => import("./ManageOprations/View"));
const MANAGE_OPRATION_UPDATE = React.lazy(
  () => import("./ManageOprations/Update")
);
const MANAGE_USER_VIEW = React.lazy(
  () => import("./Institute/ManageStudents/View")
);
const MANAGE_USER_UPDATE = React.lazy(
  () => import("./Institute/ManageStudents/Update")
);
...
const MANAGE_FLEET_CREATE = React.lazy(
  () => import("./ManageFleets/createFleet")
);
...
const MANAGE_PROJECT = React.lazy(() => import("./ManageProjects/Index"));
const MANAGE_PROJECT_CREATE = React.lazy(
  () => import("./ManageProjects/createProject")
);
const MANAGE_PROJECT_VIEW = React.lazy(() => import("./ManageProjects/View"));
const MANAGE_PROJECT_UPDATE = React.lazy(
  () => import("./ManageProjects/Update")
);
...
const UPDATE_TRUCK = React.lazy(
  () => import("./ManageTruck/UpdateTruck/index")
);
...
const WEB_PAGES = {
  ...
  //  Manage Zone F
  MANAGE_PROJECT,
  MANAGE_PROJECT_CREATE,
  MANAGE_PROJECT_VIEW,
  MANAGE_PROJECT_UPDATE,
