const PATH = {
  ...
  MANAGE_ZONE: "/zone/list",

  MANAGE_PROJECT: "/projects/list",

  MANAGE_FLEETS: "/fleet/list",
  MANAGE_FLEET_CREATE: "/create/fleet",
  MANAGE_FLEET_UPDATE: "/update/fleet",
  MANAGE_FLEET_VIEW: "/view/fleet",
  MANAGE_OPRATION_CREATE: "/manage-operation/create",

  MANAGE_ZONE_CREATE: "/manage-zone/create",
  MANAGE_PROJECT_CREATE: "/manage-project/create",
  MANAGE_PROJECT_UPDATE: "/manage-project/update",
  MANAGE_PROJECT_VIEW: "/manage-project/view",

  MANAGE_OPRATION_VIEW: "/manage-operation/view",
  MANAGE_ZONE_VIEW: "/manage-zone/view",
  MANAGE_USER_VIEW: "/manage-user/view",
  MANAGE_OPRATION_UPDATE: "/manage-operation/update",
  MANAGE_ZONE_UPDATE: "/manage-zone/update",
  MANAGE_USER_UPDATE: "/manage-user/update",
  COURSES: "/truck/list",
  TRUCK: "/truck/list",
  VIEW_TRUCK: "/truck/view/:id",
  UPDATE_TRUCK: "/truck/update/:id",
  ADD_TRUCK: "/truck/add",
