...
const PRIVATE_ROUTES: RouteType[] = [
  ...
  },
  {
    ...
    path: PATH.MANAGE_PROJECT,
    page: <WEB_PAGES.MANAGE_PROJECT />,
    routeType: ProtectedRoute,
    layout: "private",
  },

  {
    name: STRINGS.MANAGE_PROJECT_CREATE,
    path: PATH.MANAGE_PROJECT_CREATE,
    page: <WEB_PAGES.MANAGE_PROJECT_CREATE />,
    routeType: ProtectedRoute,
    layout: "private",
  },
  {
    name: STRINGS.MANAGE_PROJECT_UPDATE,
    path: PATH.MANAGE_PROJECT_UPDATE,
    page: <WEB_PAGES.MANAGE_PROJECT_UPDATE />,
    routeType: ProtectedRoute,
    layout: "private",
  },
  {
    name: STRINGS.MANAGE_PROJECT_VIEW,
    path: PATH.MANAGE_PROJECT_VIEW,
    page: <WEB_PAGES.MANAGE_PROJECT_VIEW />,
    routeType: ProtectedRoute,
    layout: "private",
  },
