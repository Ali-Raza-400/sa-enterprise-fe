...
const PRIVATE_ROUTES: RouteType[] = [
	...
	{
		name: STRINGS.MANAGE_ZONE,
		path: PATH.MANAGE_ZONE,
		page: <WEB_PAGES.MANAGE_ZONE />,
		routeType: ProtectedRoute,
		layout: "private",
	},
	{
		name: STRINGS.MANAGE_ZONE_CREATE,
		path: PATH.MANAGE_ZONE_CREATE,
		page: <WEB_PAGES.MANAGE_ZONE_CREATE />,
		routeType: ProtectedRoute,
		layout: "private",
	},
	{
		name: STRINGS.MANAGE_ZONE_UPDATE,
		path: PATH.MANAGE_ZONE_UPDATE,
		page: <WEB_PAGES.MANAGE_ZONE_UPDATE />,
		routeType: ProtectedRoute,
		layout: "private",
	},
	{
		name: STRINGS.MANAGE_ZONE_VIEW,
		path: PATH.MANAGE_ZONE_VIEW,
		page: <WEB_PAGES.MANAGE_ZONE_VIEW />,
		routeType: ProtectedRoute,
		layout: "private",
	},
	{
		name: STRINGS.MANAGE_FLEETS,
		path: PATH.MANAGE_FLEETS,
		page: <WEB_PAGES.MANAGE_FLEETS />,
		routeType: ProtectedRoute,
		layout: "private",
	},
	{
		name: STRINGS.MANAGE_FLEET_CREATE,
		path: PATH.MANAGE_FLEET_CREATE,
		page: <WEB_PAGES.MANAGE_FLEET_CREATE />,
		routeType: ProtectedRoute,
		layout: "private",
	},
	{
		name: STRINGS.MANAGE_FLEET_UPDATE,
		path: PATH.MANAGE_FLEET_UPDATE,
		page: <WEB_PAGES.MANAGE_FLEET_UPDATE />,
		routeType: ProtectedRoute,
		layout: "private",
	},
	{
		name: STRINGS.MANAGE_FLEET_VIEW,
		path: PATH.MANAGE_FLEET_VIEW,
		page: <WEB_PAGES.MANAGE_FLEET_VIEW />,
		routeType: ProtectedRoute,
		layout: "private",
	},
	{
	...
	{
		name: STRINGS.MANAGE_OPRATION_VIEW,
		path: PATH.MANAGE_OPRATION_VIEW,
		page: <WEB_PAGES.MANAGE_OPRATION_VIEW />,
		routeType: ProtectedRoute,
		layout: "private",
	},
	{
	...
	{
		name: STRINGS.MANAGE_USER_VIEW,
		path: PATH.MANAGE_USER_VIEW,
		page: <WEB_PAGES.MANAGE_USER_VIEW />,
		routeType: ProtectedRoute,
		layout: "private",
	},
	{
		name: STRINGS.MANAGE_USER_UPDATE,
		path: PATH.MANAGE_USER_UPDATE,
		page: <WEB_PAGES.MANAGE_USER_UPDATE />,
		routeType: ProtectedRoute,
		layout: "private",
	},
	{
	...
	},
	{
		name: STRINGS.TRUCK,
		path: PATH.TRUCK,
		page: <WEB_PAGES.TRUCK />,
		routeType: ProtectedRoute,
		layout: "private",
	},
	{
		name: STRINGS.VIEW_TRUCK,
		path: PATH.VIEW_TRUCK,
		page: <WEB_PAGES.VIEW_TRUCK />,
		routeType: ProtectedRoute,
		layout: "private",
	},
	{
		name: STRINGS.UPDATE_TRUCK,
		path: PATH.UPDATE_TRUCK,
		page: <WEB_PAGES.UPDATE_TRUCK />,
		routeType: ProtectedRoute,
		layout: "private",
	},
	{
		name: STRINGS.ADD_TRUCK,
		path: PATH.ADD_TRUCK,
		page: <WEB_PAGES.ADD_TRUCK />,
		routeType: ProtectedRoute,
		layout: "private",
	},
	{
